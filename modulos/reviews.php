    ...
    <div class="container">
        <div class="section-title mb-6 text-center w-75 mx-auto">
            <h4 class="mb-1 theme1">Testimonios</h4>
            <h2 class="mb-1">Criticas de nuestros <span class="theme"> clientes</span></h2>
                ...
                <div class="row review-slider">
                        ...
                        <div class="testimonial-item1 rounded">
                            <div class="author-info d-flex align-items-center">
                                <div class="author-title ms-3">
                                    <h5 class="m-0 theme">Nombre 1</h5>
                                </div>
                            </div>
                            <div class="details">
                    ...
                    <div class="col-sm-4 item">
                        <div class="testimonial-item1 rounded">
                            <div class="author-info d-flex align-items-center">
                                <div class="author-title ms-3">
                                    <h5 class="m-0 theme">Nombre 2</h5>
                                </div>
                            </div>
                            <div class="details">
                                <p class="m-0"><i class="fa fa-quote-left me-2 fs-1"></i>Lorem Ipsum is simply dummy
                    ...
                    <div class="col-sm-4 item">
                        <div class="testimonial-item1 rounded">
                            <div class="author-info d-flex align-items-center">
                                <div class="author-title ms-3">
                                    <h5 class="m-0 theme">Nombre 3</h5>
                                </div>
                            </div>
                            <div class="details">
                                <p class="m-0"><i class="fa fa-quote-left me-2 fs-1"></i>Lorem Ipsum is simply dummy
