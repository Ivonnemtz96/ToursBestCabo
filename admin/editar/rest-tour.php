...
if (isset($_REQUEST['editId']) and $_REQUEST['editId']!=""){
    ...
    if (isset($_REQUEST['submit']) and $_REQUEST['submit'] != "") {
        ...
        if ($descripcion == "" && $descripcion_ingles = "") {
            ...
            $codigo = ($restSel['imagen']); //SI NO SE SUBE LA FOTO LE DAMOS EL VALOR EXISTENTE QUE YA ESTÁ EN NUESTRA BASE DE DATOS
            ...
            if (!empty($_FILES['thumb']['tmp_name'])) {
                ...
                if ($_FILES['thumb']['type'] !== 'image/png') {
                    ...
                    header('location:/admin/editar/rest-tour?editId=' . $_REQUEST['editId'] . '');
                    exit;
                }
                ...
                if (isset($restSel['imagen'])) {
                    $archivo = '../../upload/restricciones/' . (strftime("%Y/%m", strtotime(($restSel['fr'])))) . '/' . ($restSel['imagen']) . '.png';
                ...
                $ruta = '../../upload/restricciones/' . (strftime("%Y/%m", strtotime(($restSel['fr'])))) . '';
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="descripcion"
                                                        value="<?php echo ($restSel['descripcion']);?>" type="text"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="descripcion_ingles"
                                                        value="<?php echo ($restSel['descripcion_ingles']);?>"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12 col-md-7">
                                                        <img class="responsive"
                                                            src="/upload/restricciones/<?php echo (strftime("%Y/%m", strtotime(($restSel['fr'])))); ?>/<?php echo ($restSel['imagen']) ?>.png"
                                                            alt="">
                                                        <div>
