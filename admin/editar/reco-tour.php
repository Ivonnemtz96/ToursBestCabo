...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($descripcion=="" && $descripcion_ingles == ""){
        ...
        $codigo = ($recoSel['imagen']); //SI NO SE SUBE LA FOTO LE DAMOS EL VALOR EXISTENTE QUE YA ESTÁ EN NUESTRA BASE DE DATOS
        ...
        if (!empty($_FILES['thumb']['tmp_name'])) {
            ...
            if ($_FILES['thumb']['type'] !== 'image/png') {
                ...
                header('location:/admin/editar/reco-tour?editId=' . $_REQUEST['editId'] . '');
                exit;
            }
            ...
            if (isset($recoSel['imagen'])) {
                $archivo = '../../upload/recomendaciones/' . (strftime("%Y/%m", strtotime(($recoSel['fr'])))) . '/' . ($recoSel['imagen']) . '.png';
            ...
            $ruta = '../../upload/recomendaciones/' . (strftime("%Y/%m", strtotime(($recoSel['fr'])))) . '';
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12 col-md-7">
                                                        <img class="responsive"
                                                            src="/upload/recomendaciones/<?php echo (strftime("%Y/%m", strtotime(($recoSel['fr'])))); ?>/<?php echo ($recoSel['imagen']) ?>.png"
                                                            alt="">
                                                        <div>
