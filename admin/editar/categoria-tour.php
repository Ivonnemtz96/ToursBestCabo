                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="descripcion" value="<?php echo ($cateSel['nombre']); ?>" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Descripción</label>
                                                    <input name="descripcion_ingles" value="<?php echo ($cateSel['nombreIn']); ?>" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12 col-md-7">
                                                        <img class="responsive" src="/upload/categorias/<?php echo (strftime("%Y/%m", strtotime(($cateSel['fr'])))); ?>/<?php echo ($cateSel['imagen']) ?>.png" alt="">
                                                        <div>
