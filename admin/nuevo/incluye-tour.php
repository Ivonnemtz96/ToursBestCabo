...
if (isset($_REQUEST['submit']) and $_REQUEST['submit'] != "") {
    ...
    if ($descripcion == "") {
        ...
        if ($caractCount[0]['total'] < 10000) {
            ...
            if ($insert) {
                setcookie("msg", "Qué incluye se ha agregado", time() + 2, "/");
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped" id="table-1">
                                            ...
                                            <tbody>
                                                <?php $caracteristicasData = $db->getAllRecords('toursIncluye', '*', 'ORDER BY id ASC');
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><?php echo $y ?></td>
                                                            <td><img src="/upload/incluye/<?php echo (strftime("%Y/%m", strtotime(($caracteristicas['fr']))));?>/<?php echo ($caracteristicas['imagen']) ?>.png" alt=""></td>
                                                            <td><?php echo $caracteristicas['descripcion']; ?></td>
                                                            <td><?php echo $caracteristicas['descripcion_ingles']; ?></td>
                                                            <td><a href="/admin/editar/incluye-tour?editId=<?php echo $caracteristicas['id']; ?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a></td>
                                                        </tr>
