...
if (isset($_REQUEST['submit']) and $_REQUEST['submit'] != "") {
    ...
    if ($descripcion == "") {
        ...
        if (!empty($_FILES['thumb']['tmp_name'])) {
            ...
            $ruta = '../../upload/restricciones/' . $anor . '/' . $mesr . '';
        ...
        if ($caractCount[0]['total'] < 10000) {
            ...
            if ($insert) {
                setcookie("msg", "Se ha agregado Restricción", time() + 2, "/");
            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <ul class="breadcrumb breadcrumb-style ">
                        ...
                        <li class="breadcrumb-item active">Agregar una nueva restricción</li>
                    </ul>
                            ...
                            <form method="post" enctype="multipart/form-data" class="needs-validation" novalidate="">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Agregar una restricción nueva (No incluye en tour)</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Todas las características en tours</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-striped" id="table-1">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><?php echo $y ?></td>
                                                            <td><img src="/upload/restricciones/<?php echo (strftime("%Y/%m", strtotime(($caracteristicas['fr']))));?>/<?php echo ($caracteristicas['imagen']) ?>.png" alt=""></td>
                                                            <td><?php echo $caracteristicas['descripcion']; ?></td>
                                                            <td><?php echo $caracteristicas['descripcion_ingles']; ?></td>
                                                            <td><a href="/admin/editar/rest-tour?editId=<?php echo $caracteristicas['id']; ?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a></td>
                                                        </tr>
